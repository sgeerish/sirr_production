...
class product_by_location(wizard.interface):
    ...
    form1_fields = {
             'from_date': {
                'string': 'From',
                'type': 'datetime',
                'help': 'IMPORTANT - adjust time to 00:00 to catch all resources of the day'
        },
             'to_date': {
                'string': 'To',
                'type': 'datetime',
                'help': 'IMPORTANT - adjust time to 23.59 to catch all reosurces of the day'
        },
...
product_by_location("product_by_location")
