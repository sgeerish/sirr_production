...
liste_journal_caisse_form = '''<?xml version="1.0"?>
...
class wizard_liste_journal_caisse(wizard.interface):
    ...
    states = {
        'init': {
            ...
            'result': {
                'type': 'form',
                'arch':liste_journal_caisse_form,
                'fields':liste_journal_caisse_fields,
...
#        },
        'print_report_c': {
            ...
            'result': {
                ...
                'rml' : 'ns_sales_reports/report/liste_journal_caisse.jrxml',
                'state': 'end'
            },
        },
    }

wizard_liste_journal_caisse('jreports.ns_sales_liste_journal_caisse.wizard')
