...
report_sxw.report_sxw('report.purchase.order.rndYmxMA','purchase.order','addons/purchase_discount/report/order.rml',parser=order)
report_sxw.report_sxw('report.purchase.order.rndSUow0','purchase.order','addons/purchase_discount/report/order.rml',parser=order)
report_sxw.report_sxw('report.purchase.order.rndqm5bH','purchase.order','addons/purchase_discount/report/order.rml',parser=order)
