...
liste_factures_produits_com_summ_form = '''<?xml version="1.0"?>
...
liste_factures_produits_com_summ_fields = {
...
class wizard_liste_factures_produits_com_summ(wizard.interface):
    ...
    states = {
        'init': {
            ...
            'result': {
                'type': 'form',
                'arch':liste_factures_produits_com_summ_form,
                'fields':liste_factures_produits_com_summ_fields,
...
#        },
        'print_report_c': {
            ...
            'result': {
                ...
                'rml' : 'ns_sales_reports/report/liste_factures_produits_c_com_summ.jrxml',
                'state': 'end'
            },
        },
    }

wizard_liste_factures_produits_com_summ('jreports.ns_sales_products_com_summ.wizard')
