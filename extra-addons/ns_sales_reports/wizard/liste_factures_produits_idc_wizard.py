...
liste_factures_produits_idc_form = '''<?xml version="1.0"?>
...
liste_factures_produits_idc_fields = {
...
class wizard_liste_factures_produits_idc(wizard.interface):
    ...
    states = {
        'init': {
            ...
            'result': {
                'type': 'form',
                'arch':liste_factures_produits_idc_form,
                'fields':liste_factures_produits_idc_fields,
...
#        },
        'print_report_c': {
            ...
            'result': {
                ...
                'rml' : 'ns_sales_reports/report/liste_factures_produits_c_idc.jrxml',
                'state': 'end'
            },
        },
    }

wizard_liste_factures_produits_idc('jreports.ns_sales_products_idc.wizard')
