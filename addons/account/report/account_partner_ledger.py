...
#            'sum_credit': self._sum_credit,
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        if self.result_selection == 'supplier':
            ...
            self.ACCOUNT_TYPE = ['401100','404000']
        elif self.result_selection == 'customer':
            #self.ACCOUNT_TYPE = ['receivable']
            self.ACCOUNT_TYPE = ['411100','416000']
        else:
            self.ACCOUNT_TYPE = ['466000','467000']
...
#                    "AND " + self.query +" " \
    ...
    def lines(self, partner):
        ...
        self.cr.execute(
            "SELECT l.id, l.date, j.code, acc.code as a_code, acc.name as a_name, l.ref as ref, m.name as move_name, l.name as name, l.debit, l.credit, l.amount_currency,l.currency_id, r.name AS currency_code " \
