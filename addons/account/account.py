...
class account_account_type(osv.osv):
 ...
 'Unreconciled' will copy only the journal items that were unreconciled on the first day of the new fiscal year."""),
    ...
    _defaults = {
        ...
        'sign': 1,
        'report_type': 'none',
        'company_id': lambda s, cr, uid, c: s.pool.get('res.company')._company_default_get(cr, uid, 'account.account.type', context=c),
    }
    _order = "code"
...
class account_move(osv.osv):
    ...
    def check_invoice_number(self, cr, uid,ids, xfact , xname, context=None):
		if xname == xfact:
			val ={'x_valide':True}
		else:
			val ={'x_valide':False}
