...
class report_voucher_print(report_sxw.rml_parse):
    ...
    def get_on_account(self, voucher):
        ...
        if voucher.type == 'receipt':
            ...
            title = "La caisse recevra"
            beneficiary = "Le remettant"
        elif voucher.type == 'payment':
            name = "Paiement de "+str(voucher.partner_id.name)
            title = "La caisse remettra" 
            beneficiary = "Le receptionaire"
...
report_sxw.report_sxw(
    'report.account.voucher.chq.bni',
    'account.voucher',
    'addons/account_voucher/report/account_voucher_print.rml',
    parser=report_voucher_print,header="external"
)
report_sxw.report_sxw(
    'report.account.voucher.chq.bmoi',
    'account.voucher',
    'addons/account_voucher/report/account_voucher_print.rml',
    parser=report_voucher_print,header="external"
)
report_sxw.report_sxw(
    'report.account.voucher.chq.bgfi',
    'account.voucher',
    'addons/account_voucher/report/account_voucher_print.rml',
    parser=report_voucher_print,header="external"
)
report_sxw.report_sxw(
    'report.account.voucher.chq.bfv',
    'account.voucher',
    'addons/account_voucher/report/account_voucher_print.rml',
    parser=report_voucher_print,header="external"
)
...
report_sxw.report_sxw(
    'report.account.voucher.traite.fnsr',
    'account.voucher',
    'addons/account_voucher/report/account_voucher_print.rml',
    parser=report_voucher_print,header="external"
)
