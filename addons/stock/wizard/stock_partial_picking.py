...
class stock_partial_picking(osv.osv_memory):
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        _moves_arch_lst += """
                ...
                <button icon='gtk-cancel' special="cancel"
                    string="_Cancel" />
                <button name="do_split" group="purchase.group_purchase_manager" string="_Splitter"
    ...
    def __create_partial_picking_memory(self, picking, pick_type):
        move_memory = {
            ...
            #'quantity' : min(picking.product_qty,picking.product_id.qty_available), 
            'quantity' : picking.product_qty,             
            'product_uom' : picking.product_uom.id, 
            'prodlot_id' : picking.prodlot_id.id, 
            'move_id' : picking.id,
            'picking_qty' : picking.product_qty, 
        }
    ...
    def do_split(self, cr, uid, ids, context=None):
        ...
        pick_obj.do_split(cr, uid, picking_ids, partial_datas, context=context)
        return {}
