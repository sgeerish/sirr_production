...
class stock_invoice_onshipping(osv.osv_memory):
    ...
    def _get_journal_id(self, cr, uid, context=None):
	    ...
	    print type
	    print src_usage
	    print pick.move_lines[0].location_id.name
	    if type == 'out' and dest_usage == 'supplier':
            ...
            elif type == 'in' and src_usage == 'internal':
                journal_type = 'purchase'
    ...
    def open_invoice(self, cr, uid, ids, context=None):
        ...
        fields={}
        fields['journal_id']=onshipdata_obj[0]['journal_id']
        fields['group']=onshipdata_obj[0]['group']
        fields['inv_date']=onshipdata_obj[0]['invoice_date']
        
        res = self.create_invoice(cr, uid,fields,context=context)
    ...
    def create_invoice(self, cr, uid,fields, context=None):
        if context is None:
            context = {}
        ...
        context['date_inv'] = fields['inv_date']
        active_ids = context.get('active_ids', [])
        ...
        res = picking_pool.action_invoice_create(cr, uid, active_ids,
              ...
              type = inv_type,
              context=context)
	self.pool.get('account.invoice').write(cr,uid,res[active_picking.id],{'journal_id':journal_id})
