            ...
            for move in prod.move_lines:
                ...
                for r in res[0]:
                    if r['product_id'] == move.product_id.id:
                        move_lines_obj.write(cr, uid, [move.id], {'product_qty' :  r['product_qty']*prod.th_weight})
            for m in prod.move_created_ids:
                move_lines_obj.write(cr, uid, [m.id], {'product_qty': wiz_qty.product_qty*prod.th_weight})
